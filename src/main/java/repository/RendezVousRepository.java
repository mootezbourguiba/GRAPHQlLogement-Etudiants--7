...
public class RendezVousRepository {
	...
	// Nouvelle méthode pour créer un rendez-vous
	public RendezVous createRendezVous(int id, String date, String heure, int refLog, String numTel) {
		...
		if (logement == null) {
			throw new IllegalArgumentException("Logement with reference " + refLog + " not found");
		}
		RendezVous newRendezVous = new RendezVous(id, date, heure, logement, numTel);
		listeRendezVous.add(newRendezVous);
